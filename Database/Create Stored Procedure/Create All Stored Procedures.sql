...
BEGIN
	...
	ELSE
		If UnitIDs REGEXP '^[0-9, ]*$' THEN
			SET @query = CONCAT('select UNITID, INSTNM, DEGREETOT, ENROLLTOT, SALARYTOTM, SALARYTOTF, SALARYPPM, SALARYPPF, NONACD_BLKPCT, NONACD_HSPPCT, NONACD_ASIAPCT,  PROFWOMENPCT, ASSOCPROFWOMENPCT, TENUREWOMENPCT, YEARLYHATECRIME, YEARLYHATECRIME1K, YEARLYVAWA, YEARLYVAWA1K
