...
select UNITID, CIPCODE, AWLEVEL from C2022_A
where AWLEVEL in (3, 5, 7, 8, 17, 18, 19) and LENGTH(CIPCODE) = 5 and UNITID in (select UNITID from `merged_ipeds_css_irs`.`GenderFair2024`)
