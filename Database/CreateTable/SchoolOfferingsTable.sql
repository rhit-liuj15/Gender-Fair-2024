...
select UNITID, CIPCODE, AWLEVEL from C2022_A where AWLEVEL in (3, 5, 7, 8, 17, 18, 19) and LENGTH(CIPCODE) = 5 group by UNITID, CIPCODE, AWLEVEL having sum(CTOTALT) >= 1;
