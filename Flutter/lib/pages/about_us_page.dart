...
class _AboutUsPageState extends State<AboutUsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("About Gender Fair Ratings")),
      body: ListView(
        ...
        children: [
          ...
          const Text(
            ...
            "Each school receives a total score based on four weighted categories: Leadership, Policies & Pay, Safety, and Diversity. Schools are sorted by total score by default. Sort by any category by clicking “Sort by” Dropdown. If multiple schools receive the same total score, they are considered tied in rank and are listed with the same ranking number.\n\n"
            "Data Visualizations:\n"
          ...
          Table(
            ...
            children: const [
              ...
              TableRow(children: [
                ...
                Padding(
                  padding: EdgeInsets.all(8.0),
                  child: Text("Average Pay by Gender (15%), Campus Daycare (10%, not shown)"),
                ),
              ]),
              TableRow(children: [
                Padding(
              ...
              TableRow(children: [
                ...
                Padding(
                  padding: EdgeInsets.all(8.0),
                  child: Text("Racial Diversity of Academic Staff (20%), Non-Academic Staff (5%)"),
                ),
              ]),
            ],
          ),
